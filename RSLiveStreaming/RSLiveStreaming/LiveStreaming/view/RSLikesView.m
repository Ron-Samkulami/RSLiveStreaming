...
#define RSRGBColor(r, g, b) [UIColor colorWithRed:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:1]
#define RSRGBAColor(r, g, b ,a) [UIColor colorWithRed:(r)/255.0 green:(g)/255.0 blue:(b)/255.0 alpha:a]
#define RSRandomColor RSRGBColor(arc4random_uniform(255), arc4random_uniform(100), arc4random_uniform(255))
#define PI M_PI

static NSTimeInterval totalAnimationDuration = 3;

@interface RSLikesView ()
...
@implementation RSLikesView

- (instancetype)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
        _strokeColor = [UIColor whiteColor];
        _fillColor = RSRandomColor;
...
- (void)animateInView:(UIView *)view {
    ...
    [UIView animateWithDuration:totalAnimationDuration animations:^{
        self.transform = CGAffineTransformMakeRotation(rotationDirection * PI/(4 + rotationFraction*0.2));
    } completion:NULL];
